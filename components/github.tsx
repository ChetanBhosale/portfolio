...
/**
 * GitHub conreact-activity-calendartribution graph component that displays user's contribution activity
 */
...
async function fetchContributionData(username: string): Promise<Activity[]> {
  try {
    const response = await fetch(`https://github.chetanbhosale.com/api/${username}`);
